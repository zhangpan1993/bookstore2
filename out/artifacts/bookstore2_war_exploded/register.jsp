						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput"
									name="email"  value="${uf.email}"/></td>
								<td style="color: red" align="left">${uf.err.email}</td>
							</tr>
							<tr>
								...
								<td style="color: red" align="left">${uf.err.username}</td>
							</tr>
							<tr>
								<td style="text-align:right">密码：</td>
								<td><input type="password" class="textinput"
									name="password" value="${uf.password}" /></td>
								<td style="color: red" align="left">${uf.err.password}</td>
							</tr>
							<tr>
								<td style="text-align:right">重复密码：</td>
								<td><input type="password" class="textinput"
									name="repassword" value="${uf.repassword}"/></td>
								<td style="color: red" align="left">${uf.err.repassword}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="textinput"
									style="width:350px" name="telephone" value="${uf.telephone}" /> ${uf.err.telephone}</td>
							</tr>
							<tr>
